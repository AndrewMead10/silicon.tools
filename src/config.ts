...
export const WLLAMA_CONFIG_PATHS = {
  'single-thread/wllama.wasm': "./node_modules/@wllama/wllama/src/single-thread/wllama.wasm",
  'multi-thread/wllama.wasm': "./node_modules/@wllama/wllama/src/multi-thread/wllama.wasm"
};
